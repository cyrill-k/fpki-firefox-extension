...
func verifyPolicyAndAllocateCaches(
	...
	if err == nil {
		...
		// ignore policy certificate for future requests if it wasn't added to the cache (e.g.,
		// because it was already expired or the signature could not be verified)
